// Custom SVG icons for dashboard stat cards and UI elements
// All icons use currentColor for easy theming and are ~20×20px

export function IconGamepad({ size = 20 }: { size?: number }) {
  return (
...
export function IconPrice({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
