...
import { createCrawlerRouter } from "./routes/crawler.js";
...
export async function createApp(input?: {
  ...
  const crawlerRouter = createCrawlerRouter(deps);
  ...
  registerMiddleware(app, crawlerRouter.routes());
  registerMiddleware(app, crawlerRouter.allowedMethods());
  registerMiddleware(app, imageProxyRouter.routes());
  registerMiddleware(app, imageProxyRouter.allowedMethods());
